...
startup_idea = """
A platform that lets small local shops sell leftover unsold food at the end of the day to nearby customers at discounted prices, with real-time inventory updates, pickup scheduling, and in-app payments.
"""
