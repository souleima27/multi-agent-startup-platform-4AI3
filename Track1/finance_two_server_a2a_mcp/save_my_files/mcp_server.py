...
@mcp.tool(description="Get one part of the cost knowledge base.")
...
@mcp.tool(description="Search the web using a query string and return the top 2 search results with title, url, and snippet.")
...
@mcp.tool(description="Calculate expected monthly revenue from price per sale and sales target per month.")
...
@mcp.tool(description="Calculate how many months it takes to recover the initial budget from monthly gain.")
