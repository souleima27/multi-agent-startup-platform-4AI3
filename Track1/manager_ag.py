...
def load_finance_user_input() -> dict:
    raw = load_json_file("user_input.json")
    finance = raw.get("finance_assumptions", {})

    return {
        "idea_description": raw.get("idea_description", ""),
        "problem": raw.get("problem", ""),
        "target_customer": raw.get("target_customer", {}),
        "industry": raw.get("industry", ""),
        "product_type": raw.get("product_type", ""),
        "how_it_works_one_sentence": raw.get("how_it_works_one_sentence", ""),
        "business_model": raw.get("business_model", {}),
        "price_per_sale": finance.get("price_per_sale", ""),
        "sales_target_per_month": finance.get("sales_target_per_month", ""),
        "gain_on_sale_pct": finance.get("gain_on_sale_pct", ""),
        "months": finance.get("months", ""),
        "team": raw.get("team", {}),
        "initial_budget_tnd": finance.get("initial_budget_tnd", ""),
    }
...
if __name__ == "__main__":
    user_input = load_finance_user_input()
    ops_output = load_json_file("ops_output.json")

    final_text = invoke_manager_debug(user_input, ops_output)

    save_text_output("finance_output.txt", final_text)
